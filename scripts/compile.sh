...
if [[ ":$PATH:" != *":$install_path/bin:"* ]]; then
	...
	echo "module load boost/1.62.0+gcc-6.1 cmake teem libxml2 opencv/3.1 openmpi" >> ~/.bash_profile
	...
	echo "module load boost/1.62.0+gcc-6.1 cmake teem libxml2 opencv/3.1 openmpi" >> ~/.profile
