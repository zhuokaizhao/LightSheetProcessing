...
#define M4_SET_NAN(M)                                                   \
    ((M)[ 0] = mprNan(0), (M)[ 1] = mprNan(0), (M)[ 2] = mprNan(0), (M)[ 3] = mprNan(0), \
     (M)[ 4] = mprNan(0), (M)[ 5] = mprNan(0), (M)[ 6] = mprNan(0), (M)[ 7] = mprNan(0), \
     (M)[ 8] = mprNan(0), (M)[ 9] = mprNan(0), (M)[10] = mprNan(0), (M)[11] = mprNan(0), \
     (M)[12] = mprNan(0), (M)[13] = mprNan(0), (M)[14] = mprNan(0), (M)[15] = mprNan(0))
