...
void setup_anim(CLI::App &app) {
    ...
    sub->add_option("-i, --nhdr", opt->nhdr_path, "Where nrrd header files are. (Default: nhdr/)");
    sub->add_option("-n, --name", opt->base_name, "The base name of nrrd head files (Default: three digits numbering)");
